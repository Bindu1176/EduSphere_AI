...
export default function AdminTimetablesPage() {
  ...
  return (
    <div className="p-8">
      <h1 className="text-2xl font-bold capitalize text-white">Admin Timetables Management</h1>
      <p className="text-light-muted mt-2 text-sm">Upload and manage campus timetables here. Changes will be reflected in student dashboards.</p>
      ...
      <div className="mt-8 glass-card p-12 border-dashed border-2 border-white/10 flex flex-col items-center justify-center text-center gap-4">
        ...
        <div>
          <h3 className="font-bold text-white">
            {selectedFile ? 'File Selected' : 'Upload New Timetable'}
          </h3>
          ...
          {[1, 2, 3].map(i => (
            <div key={i} className="flex items-center justify-between p-4 bg-dark-card border border-white/5 rounded-xl">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="text-sm font-bold text-white uppercase">Spring_2024_Timetable.pdf</div>
