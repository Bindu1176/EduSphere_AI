...
export default function AdminExamsPage() {
  ...
  const handleUpload = () => {
    if (selectedFile) {
      alert(`Exam Schedule "${selectedFile.name}" uploaded successfully! This update is now visible to all students.`);
  ...
  return (
    <div className="p-8">
      <h1 className="text-2xl font-bold capitalize text-white">Admin Exams Management</h1>
      <p className="text-light-muted mt-2 text-sm">Upload and manage exam schedules here.</p>
      ...
      <div className="mt-8 glass-card p-12 border-dashed border-2 border-white/10 flex flex-col items-center justify-center text-center gap-4">
        ...
        <div>
          <h3 className="font-bold text-white">
            {selectedFile ? 'File Ready' : 'Upload New Exam Schedule'}
          </h3>
